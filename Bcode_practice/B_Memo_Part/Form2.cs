...
namespace B_Memo_Part
{
    public partial class Form2 : Form
    {
        ...
        private Form3 frm3; //폼2 개체(frm3)생성
        ...
        private void textSave()
        {
            ...
            else
            {
                ...
                sw.Write(this.txtNote.Text);
                sw.Flush(); sw.Close(); this.Text = strt; this.txtNoteChange = false;
            }
        }
        ...
        private void ckw기FToolStripMenuItem_Click(object sender, EventArgs e)
        {
            if (!(frm3 == null || !frm3.Visible))
            {
                frm3.Focus(); return;
            }
            frm3 = new Form3();
            ...
            {
                frm3.txtWord.Text = this.fWord;
            }
            else
            {
                frm3.txtWord.Text = this.txtNote.SelectedText;
            }
            frm3.btnOk.Click += new System.EventHandler(this.btnOk_Click);
            frm3.Show();
        }
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            var findWord = frm3.txtWord.Text; //찾을 문자열 저장
            if (!frm3.chOption.Checked)
            {
                str = str.ToUpper(); //저장된 본문을 대문자로 변환
                findWord = findWord.ToUpper();
            }
            if (frm3.rdb01.Checked)
            {
